...
# save
incident.to_parquet("incident.parquet", index=False)
environmental.to_parquet("environmental_conditions.parquet", index=False)
resource.to_parquet("resource.parquet", index=False)
dispatch.to_parquet("dispatch.parquet", index=False)